...
data class Account(
    ...
    private val feedFinder: FeedFinder by lazy { DefaultFeedFinder(httpClient) }

    private val articleContent = ArticleContent(httpClient, userAgent, acceptLanguage)
    ...
    val faviconFinder
        get() = FaviconFinder(httpClient, faviconPolicy, userAgent, acceptLanguage)
